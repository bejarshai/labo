...
param_basicos  <- list( "cp"=          -0.764,  #complejidad minima
                        "minsplit"=   1460,     #minima cantidad de registros en un nodo para hacer el split
                        "minbucket"=  725,     #minima cantidad de registros en una hoja
                        "maxdepth"=     13 )    #profundidad mÃ¡xima del arbol
