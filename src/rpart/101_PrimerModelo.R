...
modelo  <- rpart("clase_ternaria ~ .",  #quiero predecir clase_ternaria a partir de el resto de las variables
                 ...
                 minsplit=  20,     #minima cantidad de registros para que se haga el split (tamanio del nodo min para particionarlo)
                 minbucket=  6,     #tamanio minimo de una hoja (2*minbucket < minsplit)
