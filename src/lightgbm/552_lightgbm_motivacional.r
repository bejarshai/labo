...
ksemilla  <- 999959  #poner aqui la PRIMERA de sus cinco semillas
...
modelo  <- lgb.train( data= dtrain,
                      param= list( objective=        "binary",
                                   max_bin=              100, #31
                                   learning_rate=         0.05, #0.067
                                   num_iterations=      200, #128
                                   num_leaves=          100, #100
                                   min_data_in_leaf=   1000, #1700
                                   feature_fraction=      0.5, #0.37
