...
kprefijo       <- "HT731"
ksemilla_azar  <- 999953  #Aqui poner la propia semilla
kdataset       <- "./datasets/paquete_premium_ext_721_2.csv.gz"

#donde entrenar
ktrain_mes_desde    <- 201911        #mes desde donde entreno
ktrain_mes_hasta    <- 202012        #mes hasta donde entreno, inclusive
