...
EstimarGanancia_lightgbm  <- function( x )
{
  ...
  param_basicos  <- list( objective= "binary",
                          ...
                          num_iterations= 9999,    # 9999 un numero muy grande, lo limita early_stopping_rounds
                          force_row_wise= TRUE    #para que los alumnos no se atemoricen con tantos warning
                        )

  #el parametro discolo, que depende de otro
  param_variable  <- list(  early_stopping_rounds= as.integer(50 + 5/x$learning_rate) ) # 100 | early_stopping_rounds= as.integer(50 + 5/x$learning_rate)
...
setwd("C:/Users/usuario/Desktop/CURSOS_VARIOS/2_Maestría_Datos_UTN/2 AÑO/2-AMD-EcoFin\\labo\\exp\\HT5310\\")   #Establezco el Working Directory DEL EXPERIMENTO



#en estos archivos quedan los resultados
kbayesiana  <- "HT531_2.RDATA"
klog        <- "HT531_2.txt"
